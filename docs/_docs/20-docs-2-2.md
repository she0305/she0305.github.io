...
├── _posts/                      # MarkDown formatted _posts
├── _sass/                       # Sass stylesheets
├── _templates/                  # used by Octopress to define YAML variables for new _posts/pages
...
|    └── less/
├── images/                      # images for _posts and pages
├── 404.md                       # 404 page
├── feed.xml                     # Atom feed template
├── index.md                     # sample homepage. lists 5 latest _posts
├── _posts/                       # sample post index page. lists all _posts in reverse chronology
